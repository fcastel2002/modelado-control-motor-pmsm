...
\end{figure}
\begin{lstlisting}[
caption={Codigo MATLAB Function del controlador de posicion discretizado.},
label={lst:controlador_posicion}
]
function Tm = controladorPosicion(e_wm,params)
% Calcula la orden de par Tm** en funcion del error de velocidad e_wm[k]
% usando integradores discretos tipo Tustin.
%
%   Ts    - periodo de muestreo
%   b_a   - ganancia del termino proporcional (error de velocidad)
%   K_sa  - ganancia del primer integrador (error de posicion)
%   K_sia - ganancia del segundo integrador
    ...
    % Calculo del par de referencia
    Tm = b_a*e_wm + K_sa*e_theta + K_sia*e_theta_int;

    % Actualizar estados para la proxima llamada
    e_prev           = e_wm;
