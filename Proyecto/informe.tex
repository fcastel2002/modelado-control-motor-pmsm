...
\subsubsection{Ángulo de Carga $\delta(t)$}
...
\subsubsection{Desacoplamiento de retroalimentaciones naturales}
...
\begin{equation}
    ...
    \label{eq:v0s_ref}
\end{equation}
\subsection{Comparación: desacoplamiento de retroalimentaciones físicas naturales vs. linealización por retroalimentación NL}
...
\subsection{Efecto de estimar la dependencia $R_s(T_s(t))$ vs. utilizar un valor nominal constante}
...
\subsubsection{Incorporación de Consigna de Torque: Modulador de Torque}
