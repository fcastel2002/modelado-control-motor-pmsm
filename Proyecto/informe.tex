...
Con el fin de validar la viabilidad de la implementación física del sistema diseñado, se procedió a reemplazar el diagrama de bloques del controlador discreto por código programado en lenguaje de texto estructurado (lenguaje MATLAB) encapsulado dentro de un bloque \textit{MATLAB Function}~\cite{guia_trabajo}. Este procedimiento emula rigurosamente la programación de bajo nivel que se llevaría a cabo en un microcontrolador industrial o Procesador Digital de Señales (DSP) en una aplicación mecatrónica real.
